                      ...
                      <>
                        <div href="#" className="flex flex-col-reverse items-center bg-card_white rounded-lg shadow md:flex-row-reverse md:max-w-4xl hover:bg-hover_gray">
                          <div className="flex flex-col justify-between p-4 leading-normal">
                            <div className='my-3'>
                              <span className='px-5 py-2 bg-light_gray text-xs text-black font-semibold rounded-full'>{cartProduct .category}</span>
                            </div>
                            <h5 className="mb-2 text-lg font-bold tracking-tight text-gray-900 ">{cartProduct.product_name}</h5>
                            <p className="font-normal text-gray-700 dark:text-gray-400">{cartProduct.details}</p>
                            ...
                            <div className="flex justify-between items-center my-3">
                              ...
                              <CartProductDelete cartProductId={cartProduct._id}></CartProductDelete>
                              <div>
                                <button>view details</button>
                              </div>
                            </div>
                          </div>
                          <img className="object-cover w-full rounded-t-lg h-96 md:h-80 md:min-w-11 md:rounded-none md:rounded-s-lg" src={cartProduct .productimage} alt="" />
                        </div>
                      </>
                    )
                  }
